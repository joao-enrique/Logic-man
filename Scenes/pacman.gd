...
func get_input():
	...
	if mobile_direction != Vector2.ZERO:
		...
		next_movement_direction = mobile_direction

		if mobile_direction == Vector2.LEFT:
			rotation_degrees = 0

		elif mobile_direction == Vector2.RIGHT:
			rotation_degrees = 180

		elif mobile_direction == Vector2.DOWN:
			rotation_degrees = 270

		elif mobile_direction == Vector2.UP:
			rotation_degrees = 90
